...
Filtering options (passthrough, filter_string, semantic_type, add_to_v2) are now
read from proto annotations using [(perfetto.protos.proto_filter)] field options.
