...
TEST(FixedStringWriterTest, PaddedHexInt) {
  ...
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 0>(0xAB);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "ab");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 1>(0xAB);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "ab");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 2>(0xAB);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "ab");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 4>(0xAB);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "00ab");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<' ', 5>(0xAB);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "   ab");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 2>(static_cast<uint8_t>(0xFF));
    ASSERT_EQ(writer.GetStringView().ToStdString(), "ff");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 8>(static_cast<uint32_t>(0x12345678));
    ASSERT_EQ(writer.GetStringView().ToStdString(), "12345678");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 2>(static_cast<uint64_t>(0xFF));
    ASSERT_EQ(writer.GetStringView().ToStdString(), "ff");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<' ', 16>(
        static_cast<uint64_t>(0x123456789abcdef0));
    ASSERT_EQ(writer.GetStringView().ToStdString(), "123456789abcdef0");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<' ', 18>(
        static_cast<uint64_t>(0x123456789abcdef0));
    ASSERT_EQ(writer.GetStringView().ToStdString(), "  123456789abcdef0");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
    writer.AppendPaddedHexInt<'0', 3>(0);
    ASSERT_EQ(writer.GetStringView().ToStdString(), "000");
  }
  {
    base::FixedStringWriter writer(buffer, sizeof(buffer));
...
TEST(FixedStringWriterTest, CombinedHexOperations) {
  ...
  writer.AppendHexString<'-'>(data, sizeof(data));
  writer.AppendPaddedHexInt<' ', 10>(0x12345678);
