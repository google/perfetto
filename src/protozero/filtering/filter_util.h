...
class FilterUtil {
 public:
  ...
  // command-line arguments. Args: proto_file: path to the .proto file.
 ...
 private:
  struct Message {
    struct Field {
      ...
      // Whether to add this field to v2 bytecode. Only meaningful when
      // filter_string == true and semantic_type != 0.
