...
// into the decode loops of TypedProtoDecoderBase / SelectiveProtoDecoderBase
// and into ParseOneField(): the result struct is decomposed by the compiler
// after inlining, so it does not round-trip through memory.
