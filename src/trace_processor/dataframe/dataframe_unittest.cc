...
TEST_F(DataframeBytecodeTest, SortingOfFilters) {
  ...
  RunBytecodeTest(cols, filters, {}, {}, {}, R"(
    ...
    CastFilterValue<String>: [fval_handle=FilterValue(3), write_register=Register(4), op=NonNullOp(0)]
    SortedFilter<String, EqualRange>: [col=3, val_register=Register(4), update_register=Register(0), write_result_to=BoundModifier(0)]
    CastFilterValue<Uint32>: [fval_handle=FilterValue(4), write_register=Register(5), op=NonNullOp(3)]
    SortedFilter<Uint32, UpperBound>: [col=1, val_register=Register(5), update_register=Register(0), write_result_to=BoundModifier(2)]
