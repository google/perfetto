...
#ifndef SRC_TRACE_PROCESSOR_SQLITE_SQLITE_AGGREGATE_FUNCTION_H_
#define SRC_TRACE_PROCESSOR_SQLITE_SQLITE_AGGREGATE_FUNCTION_H_
...
#endif  // SRC_TRACE_PROCESSOR_SQLITE_SQLITE_AGGREGATE_FUNCTION_H_
