...
ANDROID_VIDEO_FRAMES_TABLE = Table(
    ...
    columns=[
        ...
        C('track_name', CppOptional(CppString())),
        C('track_id', CppOptional(CppUint32())),
    ],
    tabledoc=TableDoc(
        doc='''
        ...
        columns={
            ...
            'track_name': 'Display name for the track in the UI.',
            'track_id': 'Unique identifier for the stream.',
        }))
