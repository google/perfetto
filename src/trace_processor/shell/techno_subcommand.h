...
#ifndef SRC_TRACE_PROCESSOR_SHELL_TECHNO_SUBCOMMAND_H_
#define SRC_TRACE_PROCESSOR_SHELL_TECHNO_SUBCOMMAND_H_
...
class TechnoSubcommand : public Subcommand {
 public:
...
#endif  // SRC_TRACE_PROCESSOR_SHELL_TECHNO_SUBCOMMAND_H_
