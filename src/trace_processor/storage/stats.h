...
#define PERFETTO_TP_STATS(F)                                                   \
  ...
  F(deobfuscate_location_parse_error,     kSingle,  kError,    kTrace, Scope::kMachineAndTrace,    ""), \
  ...
  F(heap_graph_invalid_string_id,         kIndexed, kError,    kTrace, Scope::kMachineAndTrace,    ""), \
  F(heap_graph_malformed_packet,          kIndexed, kError,    kTrace, Scope::kMachineAndTrace,    ""), \
  F(heap_graph_missing_packet,            kIndexed, kError,    kTrace, Scope::kMachineAndTrace,    ""), \
  ...
  F(heap_graph_non_finalized_graph,             kSingle,  kDataLoss, kTrace, Scope::kMachineAndTrace,   \
...
#define PERFETTO_TP_STATS_SCOPE_ENUM(varname, ...) varname
enum class Scope : size_t {
  PERFETTO_TP_STATS_SCOPES(PERFETTO_TP_STATS_SCOPE_ENUM),
  kNumScopes,
};

#define PERFETTO_TP_STATS_SCOPE_NAME(_, name, ...) name
