...
DROP TABLE IF EXISTS android_all_cujs;
CREATE TABLE android_all_cujs AS
SELECT * FROM android_sysui_jank_cujs
UNION
  SELECT *,
   NULL as layer_id,
   NULL AS begin_vsync,
