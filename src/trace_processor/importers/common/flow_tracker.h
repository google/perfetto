...
class FlowTracker {
 public:
  ...
  void BeginSpan(SliceId slice_id, FlowId span_id);
  void InsertSpan(SliceId, FlowId parent_span_id, FlowId span_id);
 ...
 private:
  ...
  // Flows generated using BeginSpan() and InsertSpan()
  FlowToSourceSliceMap spans_map_;
