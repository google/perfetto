...
base::Optional<SliceId> SliceTracker::BeginFrameTimeline(
  ...
  return StartSlice(row.ts, row.track_id, args_callback, [this, &row]() {
...
base::Optional<SliceId> SliceTracker::ScopedFrameEvent(
