...
TEST(HeapGraphTrackerTest, InsertObjectDiscriminators) {
  ...
  HeapGraphTracker::DiscriminatorList d1;
  d1.emplace_back(cid_field, 1);

  HeapGraphTracker::DiscriminatorList d2;
  d2.emplace_back(cid_field, 2);
  d2.emplace_back(cid2_field, 5);
