...
AndroidJobSchedulerTracker::OnTrackEventSliceExtension(
  ...
  auto job_name_iid_field = decoder.FindField(kJobNameIid);
  ...
  auto row_id = table->Insert({
      ...
      trace_context_->storage->InternString(GetAndroidJobStateName(
          get_opt_int(kState).value_or(kDefaultState))),  // state (UNKNOWN)
      trace_context_->storage->InternString(GetAndroidStandbyBucketName(
          get_opt_int(kStandbyBucket)
              .value_or(kDefaultStandbyBucket))),  // standby_bucket (UNKNOWN)
      trace_context_->storage->InternString(GetAndroidPriorityName(
      ...
      trace_context_->storage->InternString(GetAndroidProcStateName(
          get_opt_int(kProcState).value_or(kDefaultProcState))),
      trace_context_->storage->InternString(GetAndroidInternalStopReasonName(
          get_opt_int(kInternalStopReason)
              .value_or(kDefaultInternalStopReason))),
      trace_context_->storage->InternString(GetAndroidPublicStopReasonName(
      ...
      trace_context_->storage->InternString(GetAndroidBackoffPolicyName(
