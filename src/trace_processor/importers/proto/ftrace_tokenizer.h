...
#ifndef SRC_TRACE_PROCESSOR_IMPORTERS_PROTO_FTRACE_TOKENIZER_H_
#define SRC_TRACE_PROCESSOR_IMPORTERS_PROTO_FTRACE_TOKENIZER_H_
...
#endif  // SRC_TRACE_PROCESSOR_IMPORTERS_PROTO_FTRACE_TOKENIZER_H_
