...
struct ProcessName {
  chrome_enums::ProcessType type;
  const char* name;
};

constexpr ProcessName kProcessNames[] = {
    {chrome_enums::PROCESS_UNSPECIFIED, nullptr},
    {chrome_enums::PROCESS_BROWSER, "Browser"},
    {chrome_enums::PROCESS_RENDERER, "Renderer"},
    {chrome_enums::PROCESS_UTILITY, "Utility"},
    {chrome_enums::PROCESS_ZYGOTE, "SandboxHelper"},
    {chrome_enums::PROCESS_GPU, "Gpu"},
    {chrome_enums::PROCESS_PPAPI_PLUGIN, "PpapiPlugin"},
    {chrome_enums::PROCESS_PPAPI_BROKER, "PpapiBroker"},
    {chrome_enums::PROCESS_SERVICE_NETWORK,
     "Service: network.mojom.NetworkService"},
    {chrome_enums::PROCESS_SERVICE_TRACING,
     "Service: tracing.mojom.TracingService"},
    {chrome_enums::PROCESS_SERVICE_STORAGE,
     "Service: storage.mojom.StorageService"},
    {chrome_enums::PROCESS_SERVICE_AUDIO, "Service: audio.mojom.AudioService"},
    {chrome_enums::PROCESS_SERVICE_DATA_DECODER,
     "Service: data_decoder.mojom.DataDecoderService"},
    {chrome_enums::PROCESS_SERVICE_UTIL_WIN, "Service: chrome.mojom.UtilWin"},
    {chrome_enums::PROCESS_SERVICE_PROXY_RESOLVER,
     "Service: proxy_resolver.mojom.ProxyResolverFactory"},
    {chrome_enums::PROCESS_SERVICE_CDM,
     "Service: media.mojom.CdmServiceBroker"},
    {chrome_enums::PROCESS_SERVICE_MEDIA_FOUNDATION,
     "Service: media.mojom.MediaFoundationServiceBroker"},
    {chrome_enums::PROCESS_SERVICE_VIDEO_CAPTURE,
     "Service: video_capture.mojom.VideoCaptureService"},
    {chrome_enums::PROCESS_SERVICE_UNZIPPER, "Service: unzip.mojom.Unzipper"},
    {chrome_enums::PROCESS_SERVICE_MIRRORING,
     "Service: mirroring.mojom.MirroringService"},
    {chrome_enums::PROCESS_SERVICE_FILEPATCHER,
     "Service: patch.mojom.FilePatcher"},
    {chrome_enums::PROCESS_SERVICE_TTS,
     "Service: chromeos.tts.mojom.TtsService"},
    {chrome_enums::PROCESS_SERVICE_PRINTING,
     "Service: printing.mojom.PrintingService"},
    {chrome_enums::PROCESS_SERVICE_QUARANTINE,
     "Service: quarantine.mojom.Quarantine"},
    {chrome_enums::PROCESS_SERVICE_CROS_LOCALSEARCH,
     "Service: chromeos.local_search_service.mojom.LocalSearchService"},
    {chrome_enums::PROCESS_SERVICE_CROS_ASSISTANT_AUDIO_DECODER,
     "Service: chromeos.assistant.mojom.AssistantAudioDecoderFactory"},
    {chrome_enums::PROCESS_SERVICE_FILEUTIL,
     "Service: chrome.mojom.FileUtilService"},
    {chrome_enums::PROCESS_SERVICE_PRINTCOMPOSITOR,
     "Service: printing.mojom.PrintCompositor"},
    {chrome_enums::PROCESS_SERVICE_PAINTPREVIEW,
     "Service: paint_preview.mojom.PaintPreviewCompositorCollection"},
    {chrome_enums::PROCESS_SERVICE_SPEECHRECOGNITION,
     "Service: media.mojom.SpeechRecognitionService"},
    {chrome_enums::PROCESS_SERVICE_XRDEVICE,
     "Service: device.mojom.XRDeviceService"},
    {chrome_enums::PROCESS_SERVICE_READICON,
     "Service: chrome.mojom.UtilReadIcon"},
    {chrome_enums::PROCESS_SERVICE_LANGUAGEDETECTION,
     "Service: language_detection.mojom.LanguageDetectionService"},
    {chrome_enums::PROCESS_SERVICE_SHARING, "Service: sharing.mojom.Sharing"},
    {chrome_enums::PROCESS_SERVICE_MEDIAPARSER,
     "Service: chrome.mojom.MediaParserFactory"},
    {chrome_enums::PROCESS_SERVICE_QRCODEGENERATOR,
     "Service: qrcode_generator.mojom.QRCodeService"},
    {chrome_enums::PROCESS_SERVICE_PROFILEIMPORT,
     "Service: chrome.mojom.ProfileImport"},
    {chrome_enums::PROCESS_SERVICE_IME,
     "Service: chromeos.ime.mojom.ImeService"},
    {chrome_enums::PROCESS_SERVICE_RECORDING,
     "Service: recording.mojom.RecordingService"},
    {chrome_enums::PROCESS_SERVICE_SHAPEDETECTION,
     "Service: shape_detection.mojom.ShapeDetectionService"},
    {chrome_enums::PROCESS_RENDERER_EXTENSION, "Extension Renderer"},
};
