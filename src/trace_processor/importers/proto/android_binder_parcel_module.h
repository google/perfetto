...
// Parses AndroidBinderParcelEvent TracePackets into one slice per event on
// the emitting thread's track, named "<interface>::<method>". Top-level
// metadata (interface name, code, txn_id, direction, parcel sizes, etc.)
// and every ParcelFieldAnnotation become args on the slice.
