...
class ColumnView {
 public:
  ...
  // Forgets which batch's block this view was composed into. A batch taking
  // on a column from another batch has to, or narrowing it would write into
  // the other batch's storage.
