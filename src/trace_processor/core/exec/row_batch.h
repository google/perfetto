...
class RowBatch {
 public:
  ...
  // Takes on `other`'s columns and cardinality. Values are not copied: an
  // operator which passes a column through takes a second view of it.
  ...
  // Replaces a column, and whatever kept its values alive.
