...
#ifndef SRC_TRACE_PROCESSOR_CORE_DATAFRAME_IMPL_QUERY_PLAN_H_
#define SRC_TRACE_PROCESSOR_CORE_DATAFRAME_IMPL_QUERY_PLAN_H_
...
#endif  // SRC_TRACE_PROCESSOR_CORE_DATAFRAME_IMPL_QUERY_PLAN_H_
