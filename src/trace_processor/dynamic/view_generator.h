...
#ifndef SRC_TRACE_PROCESSOR_DYNAMIC_VIEW_GENERATOR_H_
#define SRC_TRACE_PROCESSOR_DYNAMIC_VIEW_GENERATOR_H_
...
class ViewGenerator : public DynamicTableGenerator {
 public:
  explicit ViewGenerator(const View*, const char* name);
  ~ViewGenerator() override;
...
#endif  // SRC_TRACE_PROCESSOR_DYNAMIC_VIEW_GENERATOR_H_
