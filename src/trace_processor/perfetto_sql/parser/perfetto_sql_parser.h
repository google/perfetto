...
class PerfettoSqlParser {
 public:
  ...
  // Whether the SQL read from here on may use a pipeline. Off until set, and
  // independent of the syntaqlite parser, so one instance serves sources which
  // differ in whether they are allowed one.
