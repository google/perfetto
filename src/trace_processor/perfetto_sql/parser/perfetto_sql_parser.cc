...
// ---------------------------------------------------------------------------
//
// Thin wrapper around the active backend implementation. Stored as
// std::optional so future implementations can be added next to `legacy`
// without changing the wrapper's shape.
