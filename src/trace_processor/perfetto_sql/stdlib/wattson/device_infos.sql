    ...
    FROM (
      VALUES
        ...
        (
          ...
          4,
          0
        ), ("SXR2230P", 5, 0), ("MT6789", 0, 0), ("MT6789", 1, 0),
        (
          "MT6789",
          2,
          0
        ), ("MT6789", 3, 0), ("MT6789", 4, 0), ("MT6789", 5, 0),
        (
          "MT6789",
          6,
          0
        ), ("MT6789", 7, 0), ("MT6858", 0, 0), ("MT6858", 1, 0),
        (
          "MT6858",
          2,
          0
    ...
    FROM (
      VALUES
        ...
        (
          ...
          0,
          0
        ), ("MT6789", 1, 0), ("MT6789", 2, 0), ("MT6789", 3, 0),
        (
          "MT6789",
          4,
          0
        ), ("MT6789", 5, 0), ("MT6789", 6, 6), ("MT6789", 7, 6),
        (
          "MT6858",
          0,
          0
...
WITH
  data(device, nominal_idle, override_idle) AS (
    ...
    FROM (
      VALUES
        ("MT6789", 4294967295, -1), ("MT6789", 0, 0), ("MT6789", 1, 1),
        (
          "MT6789",
          2,
          1
        ), ("MT6789", 3, 1), ("MT6789", 4, 1), ("MT6789", 5, 1),
        (
          "MT6789",
          6,
          1
        ), ("MT6789", 7, 1), ("MT6858", 4294967295, -1), ("MT6858", 0, 0),
        (
          "MT6858",
          1,
          1
        ), ("MT6858", 2, 1), ("MT6858", 3, 1), ("MT6858", 4, 1),
        (
          "MT6858",
          5,
          1
        ), ("MT6897", 4294967295, -1), ("MT6897", 0, 0), ("MT6897", 1, 1),
        (
          "MT6897",
          2,
          1
        ), ("MT6897", 3, 1), ("MT6897", 4, 1), ("MT6897", 5, 1),
        (
          "MT6897",
          6,
          1
        ), ("MT6897", 7, 1), ("MT6897", 8, 1), ("neo", 4294967295, -1),
        (
          "neo",
          0,
          0
        ), ("neo", 1, 1), ("neo", 2, 1), ("SXR2230P", 4294967295, -1),
        (
          "SXR2230P",
          0,
          0
