    ...
    FROM (
      VALUES
        ...
        (
          ...
          5,
          0
        ), ("SM8750", 6, 0), ("SM8750", 7, 0), ("UMS9360", 0, 0),
        (
          "UMS9360",
          1,
          0
        ), ("UMS9360", 2, 0), ("UMS9360", 3, 0), ("UMS9360", 4, 0),
        (
          "UMS9360",
          5,
          0
        ), ("UMS9360", 6, 0), ("UMS9360", 7, 0)
    ) AS _values
  )
SELECT * FROM data;
    ...
    FROM (
      VALUES
        ...
        (
          ...
          7,
          6
        ), ("UMS9360", 0, 0), ("UMS9360", 1, 0), ("UMS9360", 2, 0),
        (
          "UMS9360",
          3,
          0
        ), ("UMS9360", 4, 0), ("UMS9360", 5, 0), ("UMS9360", 6, 6),
        (
          "UMS9360",
          7,
          6
