...
WITH
  data(device, freq_khz, dep_policy, dep_freq, l3_hit, l3_miss) AS (
    ...
    FROM (VALUES
      ...
      ("Tensor G5", 268000, _dsu_dep!(), 844000000, 0.1495, 0.2087),
      ...
      ("Tensor G5", 268000, _dsu_dep!(), 1324000000, 0.2142, 0.3642),
      ...
      ("Tensor G5", 1632000, _dsu_dep!(), 537000000, 0.2115, 0.2734),
      ...
      ("Tensor G5", 2092000, _dsu_dep!(), 1324000000, 0.1538, 0.4452),
