...
INCLUDE PERFETTO MODULE wattson.curves.p25_2d;
...
WITH
  data(device, policy, freq_khz, dep_policy, dep_freq, static, active, idle0, idle1) AS (
    ...
    FROM (VALUES
      ...
      ("Tensor G4", 0, 820000, 255, 1800000, 52.1, 137.62, 2.64, 0),
      ...
      ("Tensor G4", 0, 955000, 255, 1800000, 52.67, 117.99, 2.5, 0),
      ...
      ("Tensor G4", 0, 1098000, 255, 1800000, 53.21, 140.32, 2.52, 0),
      ...
      ("Tensor G4", 0, 1197000, 255, 1800000, 53.17, 151.91, 2.43, 0),
      ...
      ("Tensor G4", 0, 1328000, 255, 1800000, 53.79, 154.61, 2.51, 0),
      ...
      ("Tensor G4", 0, 1425000, 255, 1800000, 54.37, 167.27, 2.5, 0),
      ...
      ("Tensor G4", 0, 1548000, 255, 1800000, 54.71, 177.24, 2.42, 0),
      ...
      ("Tensor G4", 0, 1696000, 255, 1800000, 55.32, 217.17, 2.38, 0),
      ...
      ("Tensor G4", 0, 1849000, 255, 1800000, 55.69, 211.69, 2.53, 0),
      ...
      ("Tensor G4", 0, 1950000, 255, 1800000, 55.47, 205.6, 2.67, 0),
