...
CREATE PERFETTO PIPELINE sched_latency_for_running_interval(
...
SUBPIPELINE _sched_with_thread_state_join AS (
  FROM sched
...
|> JOIN thread_state AS prev_ts ON prev_runnable_id = prev_ts.id
