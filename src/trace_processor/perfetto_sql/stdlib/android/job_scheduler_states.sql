...
SELECT
  ...
  job_name,
  slice_id,
  CAST(_extract_js_arg(arg_set_id, 'job_id') AS INTEGER) AS job_id,
  CAST(_extract_js_arg(arg_set_id, 'source_uid') AS INTEGER) AS uid,
  CAST(_extract_js_arg(arg_set_id, 'proxy_uid') AS INTEGER) AS proxy_uid,
  ...
  CAST(_extract_js_arg(arg_set_id, 'num_previous_attempts') AS INTEGER) AS num_previous_attempts,
  CAST(_extract_js_arg(arg_set_id, 'deadline_ms') AS INTEGER) AS deadline_ms,
  CAST(_extract_js_arg(arg_set_id, 'delay_ms') AS INTEGER) AS delay_ms,
  CAST(_extract_js_arg(arg_set_id, 'job_start_latency_ms') AS INTEGER) AS job_start_latency_ms,
  CAST(_extract_js_arg(arg_set_id, 'num_uncompleted_work_items') AS INTEGER) AS num_uncompleted_work_items,
  ...
  CAST(_extract_js_arg(arg_set_id, 'periodic_job_interval_ms') AS INTEGER) AS periodic_job_interval_ms,
  CAST(_extract_js_arg(arg_set_id, 'periodic_job_flex_interval_ms') AS INTEGER) AS periodic_job_flex_interval_ms,
  _extract_trace_tag(job_name) AS filtered_trace_tag,
  CAST(_extract_js_arg(arg_set_id, 'num_reschedules_due_to_abandonment') AS INTEGER) AS num_reschedules_due_to_abandonment,
