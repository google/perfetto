...
CREATE PERFETTO PIPELINE _startup_async_events AS
FROM slice
|> WHERE
...
CREATE PERFETTO PIPELINE _startup_complete_events AS
FROM slice
|> WHERE
     dur = 0
...
CREATE PERFETTO PIPELINE _startups_minsdk33 MATERIALIZED AS
