...
CREATE PERFETTO PIPELINE android_inputmethod_clients(
  -- Dump id
  id LONG,
...
CREATE PERFETTO PIPELINE android_inputmethod_service(
  -- Dump id
  id LONG,
  -- Timestamp when the dump was triggered
  ts TIMESTAMP,
