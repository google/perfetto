...
#ifndef SRC_TRACE_PROCESSOR_PERFETTO_SQL_SCHEMA_TYPE_MAPPING_H_
#define SRC_TRACE_PROCESSOR_PERFETTO_SQL_SCHEMA_TYPE_MAPPING_H_
...
#endif  // SRC_TRACE_PROCESSOR_PERFETTO_SQL_SCHEMA_TYPE_MAPPING_H_
