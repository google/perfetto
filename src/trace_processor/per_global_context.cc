...
PerGlobalContext::PerGlobalContext(const InitArgs& args)
...
PerGlobalContext::PerGlobalContext() = default;
PerGlobalContext::~PerGlobalContext() = default;

PerGlobalContext::PerGlobalContext(PerGlobalContext&&) = default;
PerGlobalContext& PerGlobalContext::operator=(PerGlobalContext&&) = default;
