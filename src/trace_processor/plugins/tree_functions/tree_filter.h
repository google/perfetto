...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_FILTER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_FILTER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_FILTER_H_
