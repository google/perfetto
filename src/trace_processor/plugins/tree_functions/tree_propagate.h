...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_PROPAGATE_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_PROPAGATE_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_TREE_FUNCTIONS_TREE_PROPAGATE_H_
