...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_TRACKER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_TRACKER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_TRACKER_H_
