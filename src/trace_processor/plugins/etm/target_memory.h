...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_H_
...
class TargetMemory : public Destructible {
 public:
  ...
  static const TargetMemory* Get(TraceProcessorContext* context);
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_H_
