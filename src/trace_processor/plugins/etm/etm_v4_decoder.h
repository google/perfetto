...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_V4_DECODER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_V4_DECODER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_ETM_V4_DECODER_H_
