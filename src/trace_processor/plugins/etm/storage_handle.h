...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_STORAGE_HANDLE_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_STORAGE_HANDLE_H_
...
class StorageHandle {
 public:
  ...
  explicit StorageHandle(EtmTpPlugin* plugin) : plugin_(plugin) {}
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_STORAGE_HANDLE_H_
