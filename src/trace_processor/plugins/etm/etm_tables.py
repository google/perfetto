...
"""
Contains tables related to ETM (Embedded Trace Macrocell) data.
These tables are owned by the EtmTpPlugin, not TraceStorage.
"""
...
ALL_TABLES = [ETM_V4_CONFIGURATION, ETM_V4_CHUNK, ETM_V4_SESSION]
