...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_VIRTUAL_ADDRESS_SPACE_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_VIRTUAL_ADDRESS_SPACE_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_VIRTUAL_ADDRESS_SPACE_H_
