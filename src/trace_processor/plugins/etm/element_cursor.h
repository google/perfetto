...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_ELEMENT_CURSOR_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_ELEMENT_CURSOR_H_
...
class ElementCursor : public EtmV4Decoder::Delegate {
 public:
  ElementCursor(TraceStorage* storage, EtmTpPlugin* plugin);
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_ELEMENT_CURSOR_H_
