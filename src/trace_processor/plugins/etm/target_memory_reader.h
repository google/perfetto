...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_READER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_READER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_ETM_TARGET_MEMORY_READER_H_
