...
#ifndef SRC_TRACE_PROCESSOR_PLUGINS_WATTSON_REGISTER_H_
#define SRC_TRACE_PROCESSOR_PLUGINS_WATTSON_REGISTER_H_
...
#endif  // SRC_TRACE_PROCESSOR_PLUGINS_WATTSON_REGISTER_H_
