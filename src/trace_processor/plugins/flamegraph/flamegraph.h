...
// Consumes a parent-before-child tree and returns a merged structural
// flamegraph. Presentation layout is deliberately left to PerfettoSQL.
base::StatusOr<core::Tree> Build(core::Tree&&, const Config&);
