...
class StorageTablesPlugin : public Plugin<StorageTablesPlugin> {
 public:
  ...
  void RegisterDataframes(std::vector<PluginDataframe>& out) override {
    ...
    AddDataframe(out, s->mutable_android_job_scheduler_track_event_table());
    ...
    AddDataframe(out, s->mutable_wattson_external_device_info_table());
    AddDataframe(out, s->mutable_wattson_external_cpu_policy_table());
    AddDataframe(out, s->mutable_wattson_external_deep_idle_offset_table());
    AddDataframe(out, s->mutable_wattson_external_idle_state_map_table());
    AddDataframe(out, s->mutable_wattson_external_vote_by_freq_table());
    AddDataframe(out, s->mutable_wattson_external_curves_cpu_1d_table());
    AddDataframe(out, s->mutable_wattson_external_curves_cpu_2d_table());
    AddDataframe(out, s->mutable_wattson_external_curves_l3_table());
    AddDataframe(out, s->mutable_wattson_external_curves_gpu_table());
    AddDataframe(out, s->mutable_wattson_external_curves_tpu_table());
