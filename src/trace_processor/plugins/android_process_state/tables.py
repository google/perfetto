    ...
    tabledoc=TableDoc(
        ...
        columns={
            ...
            'capability_flags':
                'Capability flags.',
            'process_group':
                'Kernel process group enum name or value.',
            'sched_group':
...
ANDROID_FREEZER_STATE_TABLE = Table(
    ...
    columns=[
        C('ts', CppOptional(CppInt64())),
        C('upid', CppUint32()),
        C('pid', CppOptional(CppInt64())),
        C('uid', CppOptional(CppInt32())),
        C('unfrozen_dur_ms', CppOptional(CppInt64())),
        C('frozen_dur_ms', CppOptional(CppInt64())),
        C('unfreeze_reason', CppOptional(CppString())),
    ...
    tabledoc=TableDoc(
        ...
        columns={
            ...
            'is_initial':
                '1 for trace-stop dump snapshot row, 0 for track event.',
        },
    ),
)
