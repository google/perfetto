...
struct DataSourceInstance {
  ...
  // not work for a v2 instance: its data sits in a ring in the producer
  ...
  // Same reasoning for stop: a v2 producer has to drain its ring before we can
  // consider the instance stopped, whether or not the data source declared
  // will_notify_on_stop.
