...
class FtraceConfigMuxer {
 public:
  ...
  bool GetAdvancedFeatureActiveForTesting() const {
    return current_state_.advanced_feature_active;
  }
 ...
 private:
  struct FtraceState {
    ...
    // Any advanced single-tenant feature active.
    bool advanced_feature_active = false;
