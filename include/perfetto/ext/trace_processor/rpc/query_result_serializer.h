...
class QueryResultSerializer {
 public:
  ...
  // integers by overlaying a TypedArray (copying at most once per batch)
  // instead of decoding a varint per cell. It is meant for the Wasm UI; the
  // HTTP+RPC path leaves this off and keeps the more compact varints.
