...
PERFETTO_PB_ENUM_IN_MSG(perfetto_protos_TrackDescriptor, ChildMergeBehavior){
    PERFETTO_PB_ENUM_IN_MSG_ENTRY(perfetto_protos_TrackDescriptor,
    ...
    PERFETTO_PB_ENUM_IN_MSG_ENTRY(perfetto_protos_TrackDescriptor,
                                  CHILD_MERGE_BEHAVIOR_BY_SIBLING_MERGE_KEY) =
        4,
};
...
PERFETTO_PB_FIELD(perfetto_protos_TrackDescriptor,
                  VARINT,
                  enum perfetto_protos_TrackDescriptor_ChildMergeBehavior,
                  child_merge_behavior,
                  14);
PERFETTO_PB_FIELD(perfetto_protos_TrackDescriptor,
                  STRING,
                  const char*,
