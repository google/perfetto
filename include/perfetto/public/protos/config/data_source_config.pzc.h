...
PERFETTO_PB_MSG_DECL(perfetto_protos_AndroidVirtualizationFrameworkConfig);
...
PERFETTO_PB_FIELD(perfetto_protos_DataSourceConfig,
                  MSG,
                  perfetto_protos_AndroidVirtualizationFrameworkConfig,
                  android_virtualization_framework_config,
                  138);
PERFETTO_PB_FIELD(perfetto_protos_DataSourceConfig,
                  STRING,
                  const char*,
