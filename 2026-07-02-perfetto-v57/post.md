...
See the [Using AI with Perfetto docs](https://perfetto.dev/docs/getting-started/using-ai) for agent-specific install paths and what the skill can do.

## 🧩 Overlapping events in JSON traces now work

Perfetto now imports overlapping `"ph": "X"` (complete) events in JSON (Chrome Trace Event Format) traces instead of silently dropping them. This was a long-standing pain point ([#4280](https://github.com/google/perfetto/issues/4280)) for tools which emit overlapping synchronous events, notably traces from the **PyTorch profiler**: the affected slices vanished from both the timeline and SQL, and some users were resorting to self-hosting old versions of the UI. Overlapping events are now ingested onto overflow tracks which the UI merges back into a single thread track, so everything is visible in the timeline and queryable in SQL.

![overlapping JSON events rendering in the timeline](overlapping-json-events-rendering-in-the-timeline.png)
...
- A new **`linux.systemd_journald` data source** records journald entries while tracing, with filters for minimum syslog priority, `SYSLOG_IDENTIFIER`s, and systemd unit names.
...
## New Contributors
* @chrislu0129 made their first contribution in https://github.com/google/perfetto/pull/6012
* @harshitrawatjgd made their first contribution in https://github.com/google/perfetto/pull/5983
* @zzl360 made their first contribution in https://github.com/google/perfetto/pull/6048
* @Piotrek605 made their first contribution in https://github.com/google/perfetto/pull/6089
* @yuzhy8701 made their first contribution in https://github.com/google/perfetto/pull/6161
* @BogdanLionte made their first contribution in https://github.com/google/perfetto/pull/6175
* @abhmen01 made their first contribution in https://github.com/google/perfetto/pull/5284
* @fmeawad made their first contribution in https://github.com/google/perfetto/pull/6279
* @noamraph made their first contribution in https://github.com/google/perfetto/pull/6264
* @shaybarak made their first contribution in https://github.com/google/perfetto/pull/6278

*For complete details, see the [changelog](https://github.com/google/perfetto/blob/v57.1/CHANGELOG) or [view all changes on GitHub](https://github.com/google/perfetto/compare/v56.1...v57.1).*

*Download Perfetto v57.1 from our [releases page](https://github.com/google/perfetto/releases), get started at [docs.perfetto.dev](https://perfetto.dev/docs/), or try the UI directly at [ui.perfetto.dev](https://ui.perfetto.dev/).*

**Full Changelog**: https://github.com/google/perfetto/compare/v56.1...v57.1
