...
class BigtraceOrchestratorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Query = channel.unary_stream(
                ...
                request_serializer=protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryArgs.SerializeToString,
                response_deserializer=protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryResponse.FromString,
...
def add_BigtraceOrchestratorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Query': grpc.unary_stream_rpc_method_handler(
                    servicer.Query,
                    request_deserializer=protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryArgs.FromString,
                    response_serializer=protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'perfetto.protos.BigtraceOrchestrator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('perfetto.protos.BigtraceOrchestrator', rpc_method_handlers)
...
class BigtraceOrchestrator(object):
    ...
    def Query(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/perfetto.protos.BigtraceOrchestrator/Query',
            protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryArgs.SerializeToString,
            protos_dot_perfetto_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
