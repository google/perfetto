...
class AndroidVirtualizationFrameworkConfig(_message.Message):
    __slots__ = ["android_vm_config"]
    class AndroidVmConfig(_message.Message):
        __slots__ = ["name"]
        NAME_FIELD_NUMBER: _ClassVar[int]
        name: str
        def __init__(self, name: _Optional[str] = ...) -> None: ...
    ANDROID_VM_CONFIG_FIELD_NUMBER: _ClassVar[int]
    android_vm_config: _containers.RepeatedCompositeFieldContainer[AndroidVirtualizationFrameworkConfig.AndroidVmConfig]
    def __init__(self, android_vm_config: _Optional[_Iterable[_Union[AndroidVirtualizationFrameworkConfig.AndroidVmConfig, _Mapping]]] = ...) -> None: ...
...
class DataSourceConfig(_message.Message):
    ...
    ANDROID_VIRTUALIZATION_FRAMEWORK_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    android_virtualization_framework_config: AndroidVirtualizationFrameworkConfig
