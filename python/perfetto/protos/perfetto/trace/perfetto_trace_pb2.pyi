...
class TrackDescriptor(_message.Message):
    __slots__ = ["atrace_name", "child_ordering", "chrome_thread", "counter", "description", "disallow_merging_with_system_tracks", "name", "parent_uuid", "process", "sibling_merge_behavior", "sibling_merge_key", "sibling_merge_key_int", "sibling_order_rank", "static_name", "thread", "uuid"]
