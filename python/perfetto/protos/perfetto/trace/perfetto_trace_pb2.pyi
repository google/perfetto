...
class UserList(_message.Message):
    __slots__ = ["parse_error", "read_error", "users"]
    ...
    parse_error: bool
    read_error: bool
    users: _containers.RepeatedCompositeFieldContainer[UserList.UserInfo]
    def __init__(self, users: _Optional[_Iterable[_Union[UserList.UserInfo, _Mapping]]] = ..., parse_error: bool = ..., read_error: bool = ...) -> None: ...

class UserListConfig(_message.Message):
