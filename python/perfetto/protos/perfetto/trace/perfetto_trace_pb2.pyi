...
class FtraceEvent(_message.Message):
    ...
    TICKER_TICK_FIELD_NUMBER: _ClassVar[int]
    ...
    ticker_tick: TickerTickFtraceEvent
...
class TickerTickFtraceEvent(_message.Message):
    __slots__ = ["count"]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    count: int
