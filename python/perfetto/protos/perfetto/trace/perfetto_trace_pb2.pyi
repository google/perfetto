...
class GenericKernelProcessTree(_message.Message):
    ...
    def __init__(self, processes: _Optional[_Iterable[_Union[GenericKernelProcessTree.Process, _Mapping]]] = ..., threads: _Optional[_Iterable[_Union[GenericKernelProcessTree.Thread, _Mapping]]] = ..., collection_end_timestamp: _Optional[int] = ...) -> None: ...
