...
class PriorityBoostConfig(_message.Message):
    __slots__ = ["nice_value", "realtime_priority"]
    NICE_VALUE_FIELD_NUMBER: _ClassVar[int]
    REALTIME_PRIORITY_FIELD_NUMBER: _ClassVar[int]
    nice_value: int
    realtime_priority: int
    def __init__(self, nice_value: _Optional[int] = ..., realtime_priority: _Optional[int] = ...) -> None: ...
