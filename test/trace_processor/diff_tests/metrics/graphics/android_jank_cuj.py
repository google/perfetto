...
# trace.add_thread(
#       tid=PID, tgid=PID, cmdline="MainThread", name="MainThread")
trace.add_thread(
...
add_instant_for_track(
  trace,
  ts=7,
  track=FIRST_CUJ_TRACK,
  name="FT#beginVsync#10")
...
trace.add_track_event_slice_begin(
    ts=5, track=FIRST_CUJ_TRACK, name=first_cuj)
trace.add_track_event_slice_end(ts=100_000_000, track=FIRST_CUJ_TRACK)
trace.add_track_event_slice_begin(
    ts=10, track=SHADE_CUJ_TRACK, name=shade_cuj)
