...
def add_blocking_calls_per_frame_multiple_cuj_instance(trace, cuj_name):
  ...
  trace.add_async_atrace_for_thread(ts=25_000_000, ts_end=77_000_000, buf=cuj_name, pid=SYSUI_PID, tid=SYSUI_UI_TID)
  trace.add_async_atrace_for_thread(ts=83_000_000, ts_end=102_000_000, buf=cuj_name, pid=SYSUI_PID, tid=SYSUI_UI_TID)
...
def add_ignored_latency_cujs(trace):
  ...
  trace.add_async_atrace_for_thread(ts=150_000_000, ts_end=155_000_000, buf=cuj_1, pid=SYSUI_PID, tid=SYSUI_UI_TID)
  trace.add_async_atrace_for_thread(ts=156_000_000, ts_end=160_000_000, buf=cuj_2, pid=SYSUI_PID, tid=SYSUI_UI_TID)
