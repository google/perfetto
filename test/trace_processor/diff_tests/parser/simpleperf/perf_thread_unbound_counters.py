...
def main():
  ...
  # Mode 2 (pid >= 0, cpu == -1): single fd per thread unbound to CPU
  cycles_ids = [1]
  instr_ids = [11]
  ...
  records = b''.join([
      ...
      pack_comm(1000, 1001, 'unbound-worker'),
      # Single fd follows thread across CPU 0 -> CPU 1 -> CPU 0 monotonically
      pack_sample(0x401000, 1000, 1001, 1000, 1, 0, [(1000, 1), (2000, 11)]),
      pack_sample(0x401010, 1000, 1001, 2000, 1, 1, [(1500, 1), (3000, 11)]),
      pack_sample(0x401020, 1000, 1001, 3000, 1, 0, [(2200, 1), (4400, 11)]),
  ])
