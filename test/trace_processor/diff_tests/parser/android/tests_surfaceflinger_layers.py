...
class SurfaceFlingerLayers(TestSuite):
  ...
  def test_displays_table(self):
    return DiffTestBlueprint(
        ...
        SELECT dis.id, dis.snapshot_id, dis.is_on, dis.is_virtual, dis.display_id, dis.display_name, RR.x, RR.y, RR.w, RR.h
        ...
        3,2,1,0,4619827677550801152,"[NULL]",0.000000,0.000000,1080.000000,2400.000000
        4,2,0,0,4619827677550801153,"Other",0.000000,0.000000,1080.000000,1080.000000
        """))
