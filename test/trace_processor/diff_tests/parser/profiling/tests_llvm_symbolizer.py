  ...
  def test_callstack_sampling_flamegraph(self):
    return DiffTestBlueprint(
        ...
        out=Csv('''
          ...
          1,7689491063351,1,"__pthread_start(void*)","/apex/com.android.runtime/lib64/bionic/libc.so",0,560,0,560,0,0,0,0,0,"[NULL]","[NULL]"
          2,7689491063351,2,"art::Thread::CreateCallback(void*)","/apex/com.android.art/lib64/libart.so",0,301,0,301,0,0,0,0,1,"[NULL]","[NULL]"
          3,7689491063351,3,"art::JValue art::InvokeVirtualOrInterfaceWithJValues<art::ArtMethod*>(art::ScopedObjectAccessAlreadyRunnable const&, _jobject*, art::ArtMethod*, jvalue const*)","/apex/com.android.art/lib64/libart.so",0,301,0,301,0,0,0,0,2,"[NULL]","[NULL]"
          4,7689491063351,4,"art::ArtMethod::Invoke(art::Thread*, unsigned int*, unsigned int, art::JValue*, char const*)","/apex/com.android.art/lib64/libart.so",0,301,0,301,0,0,0,0,3,"[NULL]","[NULL]"
          5,7689491063351,5,"art_quick_invoke_stub","/apex/com.android.art/lib64/libart.so",0,301,0,301,0,0,0,0,4,"[NULL]","[NULL]"
          6,7689491063351,6,"com.android.server.ServiceThread.run","/system/framework/oat/arm64/services.odex",0,148,0,148,0,0,0,0,5,"[NULL]","[NULL]"
          7,7689491063351,7,"android.os.HandlerThread.run","/system/framework/arm64/boot-framework.oat",0,148,0,148,0,0,0,0,6,"[NULL]","[NULL]"
          8,7689491063351,8,"android.os.Looper.loop","/system/framework/arm64/boot-framework.oat",0,148,0,148,0,0,0,0,7,"[NULL]","[NULL]"
          9,7689491063351,9,"android.os.Looper.loopOnce","/system/framework/arm64/boot-framework.oat",0,148,0,148,0,0,0,0,8,"[NULL]","[NULL]"
        '''))
