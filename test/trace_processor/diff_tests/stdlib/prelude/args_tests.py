...
class ArgsFunction(TestSuite):
  ...
  def test_print_args_simple(self):
    return DiffTestBlueprint(
        trace=TextProto(r"""
        packet {
          trusted_packet_sequence_id: 1
        ...
        SELECT
          name,
          print_args(arg_set_id) AS args_json
        FROM slice;
        """,
        out=Csv("""
        "name","args_json"
  ...
  def test_print_args_empty(self):
    return DiffTestBlueprint(
        trace=TextProto(r"""
        packet {
          trusted_packet_sequence_id: 1
        ...
        SELECT
          name,
          COALESCE(print_args(arg_set_id), '{}') AS args_json
        FROM slice;
        """,
        out=Csv("""
        "name","args_json"
  ...
  def test_print_args_complex_types(self):
    return DiffTestBlueprint(
        trace=TextProto(r"""
        packet {
          trusted_packet_sequence_id: 1
  ...
  def test_print_args_nested(self):
    return DiffTestBlueprint(
        trace=TextProto(r"""
        packet {
          trusted_packet_sequence_id: 1
  ...
  def test_print_args_with_arrays(self):
    return DiffTestBlueprint(
        trace=TextProto(r"""
        packet {
          trusted_packet_sequence_id: 1
  ...
  def test_print_args_preserves_order(self):
    """Test that print_args preserves the insertion order of arguments
