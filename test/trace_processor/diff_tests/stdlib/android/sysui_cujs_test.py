...
class SystemUICujs(TestSuite):
  ...
  def test_android_sysui_jank_cujs(self):
    return DiffTestBlueprint(
        ...
        2,1,"com.android.systemui","J<BACK_PANEL_ARROW>","BACK_PANEL_ARROW",24,85000000,89000000,4000000,"completed",3,2,"TX - third_layer#2",60,70
        3,2,"com.google.android.apps.nexuslauncher","J<CUJ_NAME>","CUJ_NAME",38,121000000,143000000,22000000,"completed",5,1,"TX - second_layer#1",80,90
        """))
