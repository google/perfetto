...
class Frames(TestSuite):
  ...
  def test_android_frames(self):
    return DiffTestBlueprint(
        ...
        170,1100000000,500000000,147,153,145,144,4,2,1,1,1,2,"com.android.systemui"
        """))
  ...
  def test_android_frames_layers(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          ...
          170,1100000000,500000000,1600000000,147,153,145,144,4,2,0,"TX - NotificationShade#0",2,"com.android.systemui"
          """))
  ...
  def test_android_cpu_time_per_frame(self):
    return DiffTestBlueprint(
        ...
        170,0,100000000,150000000,250000000
        """))
  ...
  def test_android_frame_stats(self):
    return DiffTestBlueprint(
        ...
        170,480000000,250000000,100000000,1,1,1,1
        """))
