...
class WattsonStdlib(TestSuite):
  ...
  def test_wattson_suspend_calculations(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            ...
            24792794948689,0,39.690000,39.690000,39.690000,0.000000,0.000000,0.000000,0.000000,0.000000,"[NULL]"
            24792794948689,205625,39.690000,39.690000,39.690000,39.690000,0.000000,0.000000,0.000000,0.000000,18.390000
            24792795154314,0,39.690000,0.000000,39.690000,39.690000,0.000000,0.000000,0.000000,0.000000,"[NULL]"
            """))
  ...
  def test_wattson_devfreq_hotplug_and_suspend(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            "ts","dur","cpu0_mw","cpu1_mw","cpu2_mw","cpu3_mw","cpu4_mw","cpu5_mw","cpu6_mw","cpu7_mw","dsu_scu_mw"
            165725450194,0,111.020000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,"[NULL]"
            ...
            165725483600,0,111.020000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,"[NULL]"
            """))
