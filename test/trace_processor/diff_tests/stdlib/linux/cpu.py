...
class LinuxCpu(TestSuite):
  ...
  def test_cpu_cycles_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          31636287288,31,76193077,614400,1708800,415212
            """))
  ...
  def test_cpu_cycles_per_thread_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            ...
            14,1247778191,1,2446930,614400,614400,510130
            15,1407232193,1,2384063,614400,614400,590281
            16,505278870,0,1142238,614400,614400,442450
