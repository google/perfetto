...
class LinuxCpu(TestSuite):
  ...
  def test_cpu_cycles_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          31636287379,31,76193077,614400,1708800,660492
            """))
  ...
  def test_cpu_cycles_per_cpu(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          ...
          1,3985923237512,3985,2247149674,930000,1803000,1773768
          2,4047926756581,4047,2276274170,930000,1803000,1778312
          3,3992276081242,3992,2248956757,930000,1803000,1775168
          4,5134318459625,5134,2203887266,553000,2348000,2329664
          5,5615703220380,5615,2438499077,553000,2348000,2302934
          6,4715590442538,4715,1737264802,500000,2850000,2714376
          7,4594701918170,4594,1719270548,500000,2850000,2672471
            """))
  ...
  def test_cpu_cycles_per_cpu_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "cpu","millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          0,27811901913,27,50296201,614400,1708800,665246
          1,2893791436,2,4709947,614400,614400,614400
          2,177750720,0,3718178,864000,864000,864000
          3,752843308,0,17468751,614400,864000,640490
            """))
  ...
  def test_cpu_cycles_per_thread(self):
    return DiffTestBlueprint(
        ...
        1,39042295641,39,28747861,614400,1708800,1358093
        2,286312857,0,167552,1708800,1708800,1708800
        8,124651656672,124,99592232,614400,1708800,1251620
            """))
  ...
  def test_cpu_cycles_per_thread_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            "utid","millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
            1,1226879385,1,1996874,614400,614400,614400
            14,1247778201,1,2446930,614400,614400,614400
            15,1407232204,1,2384063,614400,614400,614400
            16,505278873,0,1142238,614400,614400,614400
            30,29888102,0,48646,614400,614400,614400
            ...
            61,151616102,0,246771,614400,614400,614400
            62,58740000,0,8307552,1708800,1708800,1708800
            92,243675648,0,962397,864000,864000,864000
            """))
  ...
  def test_cpu_cycles_per_process(self):
    return DiffTestBlueprint(
        ...
        1,79550724691,79,56977346,614400,1708800,1396181
        2,286312857,0,167552,1708800,1708800,1708800
        8,124651656672,124,99592232,614400,1708800,1251620
            """))
  ...
  def test_cpu_cycles_per_process_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "upid","millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          1,2163648307,2,3521563,614400,614400,614400
          14,1247778201,1,2446930,614400,614400,614400
          15,1407232204,1,2384063,614400,614400,614400
          16,505278873,0,1142238,614400,614400,614400
            """))
