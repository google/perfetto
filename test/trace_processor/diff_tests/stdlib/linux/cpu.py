...
class LinuxCpu(TestSuite):
  ...
  def test_cpu_cycles_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          31636287288,31,76193077,614400,1708800,660492
            """))
  ...
  def test_cpu_cycles_per_thread_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            ...
            14,1247778191,1,2446930,614400,614400,614669
            15,1407232193,1,2384063,614400,614400,614511
            16,505278870,0,1142238,614400,614400,614694
            ...
            62,58740000,0,8307552,1708800,1708800,1727647
            92,243675648,0,962397,864000,864000,864098
            """))
  ...
  def test_cpu_cycles_per_process_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "upid","millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          1,2163648305,2,3521563,614400,614400,614498
          14,1247778191,1,2446930,614400,614400,614669
          15,1407232193,1,2384063,614400,614400,614511
          16,505278870,0,1142238,614400,614400,614694
            """))
