...
class LinuxCpu(TestSuite):
  ...
  def test_cpu_cycles_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          31636287379,31,76193077,614400,1708800,415212
            """))
  ...
  def test_cpu_cycles_per_cpu_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
          "cpu","millicycles","megacycles","runtime","min_freq","max_freq","avg_freq"
          0,27811901913,27,50296201,614400,1708800,552962
          1,2893791436,2,4709947,614400,614400,614400
          2,177750720,0,3718178,864000,864000,47805
          3,752843308,0,17468751,614400,864000,43096
            """))
  ...
  def test_cpu_cycles_per_thread_in_interval(self):
    return DiffTestBlueprint(
        ...
        out=Csv("""
            ...
            14,1247778201,1,2446930,614400,614400,509936
            15,1407232204,1,2384063,614400,614400,590266
            16,505278873,0,1142238,614400,614400,442358
            ...
            62,58740000,0,8307552,1708800,1708800,7070
            92,243675648,0,962397,864000,864000,253196
            """))
