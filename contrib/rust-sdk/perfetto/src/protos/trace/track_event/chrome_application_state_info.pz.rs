...
pb_enum!(ChromeApplicationStateInfoChromeApplicationState {
...
pb_msg!(ChromeApplicationStateInfo {
    application_state: ChromeApplicationStateInfoChromeApplicationState, enum, 1,
});
