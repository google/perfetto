...
export class CDFChart implements m.ClassComponent<CDFChartAttrs> {
  ...
  view({attrs}: m.Vnode<CDFChartAttrs>): m.Children {
    ...
    return m(
      '.pf-cdf-chart',
      {
        class: classNames(fillParent && 'pf-cdf-chart--fill-parent', className),
      ...
      [
        ...
        title &&
          m(
            '.pf-cdf-chart__header',
            {
              class: classNames(
                hasActiveFilter && 'pf-cdf-chart__header--active-filter',
              ),
            },
            m('.pf-cdf-chart__title', title),
          ),
        m(
          'svg.pf-cdf-chart__svg',
          {
          ...
          [
            ...
            m(
              ...
              [
                ...
                m('rect.pf-cdf-chart__background', {
                  x: 0,
                  y: 0,
                  width: chartWidth,
                  height: chartHeight,
                ...
                ...data.lines.map((cdfLine) => {
                  ...
                  return m('path.pf-cdf-chart__line', {
                    'd': pathData || '',
                    'stroke': color,
                    'fill': 'none',
                    'stroke-width': 2,
  ...
  private renderBrushOverlay(
    ...
    return m('rect.pf-cdf-chart__brush-selection', {
      x,
      y: 0,
      width,
      height: chartHeight,
  ...
  private renderPercentileLine(
    ...
    return m('g.pf-cdf-chart__percentile', [
      m('line.pf-cdf-chart__percentile-line', {
        x1: x,
        y1: 0,
        x2: x,
        y2: chartHeight,
      ...
      m(
        'text.pf-cdf-chart__percentile-label',
        {
          'x': x,
          'y': -5,
          'text-anchor': 'middle',
      ...
      m(
        'text.pf-cdf-chart__percentile-value',
        {
          'x': x,
          'y': chartHeight + 15,
          'text-anchor': 'middle',
  ...
  private renderCrosshairLine(
    ...
    return m('g.pf-cdf-chart__crosshair', [
      m('line.pf-cdf-chart__crosshair-line', {
        x1: x,
        y1: 0,
        x2: x,
        y2: chartHeight,
      ...
      ...lineValues.map((lv) => {
        return m('circle.pf-cdf-chart__crosshair-dot', {
          cx: x,
  ...
  private renderTooltip(
    ...
    return m(
      ...
      m('.pf-histogram__tooltip-content', [
        m('.pf-histogram__tooltip-row', formatXValue(xValue)),
        ...lineValues.map((lv) =>
          m('.pf-histogram__tooltip-row', [
            m(
              'span',
  ...
  private renderLoading(
    ...
    return m(
      ...
      m('.pf-cdf-chart__loading', m(Spinner)),
    );
  }
  ...
  private renderEmpty(
    ...
    return m(
      ...
      m('.pf-cdf-chart__empty', 'No data to display'),
    );
  }
}
