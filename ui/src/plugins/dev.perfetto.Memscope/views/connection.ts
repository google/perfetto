        ...
        m(
          ...
          m(
            SegmentedButtons,
            {
              ...
              onOptionSelected: (i: string) => {
                this.connectionMethod = i as ConnectionMethod;
                this.error = undefined;
              },
            },
            m(SegmentedButton, {value: 'usb', icon: 'usb'}, 'USB'),
            m(SegmentedButton, {value: 'websocket', icon: 'lan'}, 'WebSocket'),
            m(
              SegmentedButton,
              {value: 'web_proxy', icon: 'corporate_fare'},
              'Web Proxy',
            ),
            m(SegmentedButton, {value: 'linux', icon: 'computer'}, 'Linux'),
          ),
