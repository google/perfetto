...
// Analysis provider holder — set via the plugin's public method.
export class AnalysisProviderHolder {
  private provider: AnalysisProvider | undefined;

  register(provider: AnalysisProvider): void {
    this.provider = provider;
  }

  get(): AnalysisProvider | undefined {
