...
function renderStatusCard(
  ...
  return m(
    Card,
    {
      className: `pf-trace-info-page__status-card pf-trace-info-page__status-card--${severity}`,
    },
    m(
      ...
      count > 0 &&
        m(
          Anchor,
          {
            className: 'pf-trace-info-page__status-link',
            onclick: () => attrs.onTabChange(targetTab),
          },
