...
export async function getOverview(engine: Engine): Promise<OverviewData> {
  ...
  // Duplicate bitmaps grouped by (width, height). Uses shallow size since
  // bitmap pixel data lives in native memory. Skipped when
  // heap_graph_primitive is empty (proto heap graphs lack HPROF field data).
