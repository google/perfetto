...
// dev.perfetto.LlmProtocolOpenAi - registers the 'openai-compatible' protocol
// with the common LLM gateway. One protocol for every /v1/chat/completions
// server: OpenAI, llama.cpp's llama-server (--jinja), vLLM, LM Studio, Ollama's
// OpenAI endpoint, etc. Point a provider at the right base URL (and an API key
