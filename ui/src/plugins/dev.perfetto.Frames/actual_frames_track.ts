  ...
  return SliceTrack.create({
    ...
    tooltip: (slice) => {
      ...
      if (tag && tag !== 'No Jank' && tag !== 'None') {
        ...
        if (tag === 'Self Jank') {
          headerIcon = '🔴';
          headerTitle = 'Self Jank';
        } else if (tag === 'Other Jank') {
          headerIcon = '🟡';
          headerTitle = 'Other Jank';
        } else if (tag === 'Dropped Frame' || tag === 'Dropped') {
          headerIcon = '🚫';
          headerTitle = 'Dropped Frame';
        } else if (tag === 'Non-perceivable Jank') {
          headerIcon = '⚪';
          headerTitle = 'Non-perceivable Jank';
        }
