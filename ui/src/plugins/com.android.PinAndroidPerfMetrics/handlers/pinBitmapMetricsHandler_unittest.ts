...
const validMetricsTest: {
  ...
  {
    inputMetric: 'perfetto_android_bitmap_metric_max_val-com.android.systemui',
    expectedOutput: {
  ...
  {
    inputMetric:
      'perfetto_android_bitmap_metric_max_val-com.google.android.apps.nexuslauncher',
    expectedOutput: {
...
describe('PinBitmapMetricsHandler_match', () => {
