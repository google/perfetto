...
Extension plugins declare `dev.perfetto.GpuCompute` as a dependency and call
...
import {createTerminology, registerTerminology} from '../dev.perfetto.GpuCompute/terminology';
import GpuComputePlugin from '../dev.perfetto.GpuCompute';

export default class MyTerminologyPlugin implements PerfettoPlugin {
  static readonly id = 'dev.perfetto.GpuCompute.Terminology.MyVendor';
...
```ts
import {PerfettoPlugin} from '../../public/plugin';
import {registerSection} from '../dev.perfetto.GpuCompute/section';
import GpuComputePlugin from '../dev.perfetto.GpuCompute';
...
```ts
import {PerfettoPlugin} from '../../public/plugin';
import {registerWellKnownMetric} from '../dev.perfetto.GpuCompute/section';
import GpuComputePlugin from '../dev.perfetto.GpuCompute';
...
```ts
import {PerfettoPlugin} from '../../public/plugin';
import {registerAnalysisProvider} from '../dev.perfetto.GpuCompute/analysis';
import GpuComputePlugin from '../dev.perfetto.GpuCompute';
