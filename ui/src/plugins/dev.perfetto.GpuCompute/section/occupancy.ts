...
export function registerOccupancySection(): void {
  registerSection({
    id: 'dev.perfetto.GpuCompute.Section.Occupancy',
    title: 'Occupancy',
    order: 2,
    launchMetrics: [
    ...
    tables: [
      {
        ...
        rows: [
          {
            id: 'launch__occupancy_limit_blocks',
            label: (t) => `${t.block.title} Limit ${t.sm.title}`,
            unit: (t) => `${t.block.name}`,
            importance: 'optional',
          },
          {
            id: 'launch__occupancy_limit_registers',
            label: (t) => `${t.block.title} Limit Registers`,
            unit: (t) => `${t.block.name}`,
            importance: 'optional',
          },
          {
            id: 'launch__occupancy_limit_shared_mem',
            label: (t) => `${t.block.title} Limit ${t.sharedMem.title}`,
            unit: (t) => `${t.block.name}`,
            importance: 'optional',
          },
          {
            id: 'launch__occupancy_limit_warps',
            label: (t) => `${t.block.title} Limit ${t.warp.pluralTitle}`,
            unit: (t) => `${t.block.name}`,
            importance: 'optional',
          },
          {
            id: 'launch__occupancy_limit_barriers',
