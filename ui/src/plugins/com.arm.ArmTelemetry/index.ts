...
import {ArmTelemetryCpuSpec} from '../com.arm.ArmTelemetrySpec/arm_telemetry_spec';
...
export default class implements PerfettoPlugin {
  ...
  static readonly dependencies = [StandardGroupsPlugin, ArmTelemetrySpecPlugin];
  ...
  async onTraceLoad(ctx: Trace): Promise<void> {
    ...
    const telemetrySpecManager = ArmTelemetrySpecPlugin.getManager();
