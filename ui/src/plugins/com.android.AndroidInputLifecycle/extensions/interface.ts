 ...
 * Maps to a column in the visualizer UI and specifies how to extract
...
export interface StageDefinition {
  ...
  // If present, visualizer shows the delta between tsField and this field.
  readonly prevTsField?: string;
}
...
/**
 * Interface for registering input lifecycle visualizer extensions.
 *
 ...
 * into the main visualizer timeline and grid view.
 */
