  ...
  switch (setting.type) {
    case 'number':
      return m(TextInput, {
        ...
        onChange: (value: string) => {
          console.log('Number onChange', value);
    ...
    case 'string':
      ...
      return m(TextInput, {
        ...
        disabled,
        onChange: (value: string) => {
          console.log('String onChange', value);
          setting.set(value);
        },
      });
    case 'boolean':
        return m(Checkbox, {
            ...
            onchange: (e: Event) => {
                ...
                if (e.currentTarget instanceof HTMLLabelElement) {
                    ...
                    if (input) {
                        console.log('Checkbox onchange value', input.checked);
      ...
      return m(
          Select,
          {
            ...
            onchange: (e: Event) => {
              ...
              console.log('Select onchange', target.value);
