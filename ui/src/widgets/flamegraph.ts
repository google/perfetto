...
export interface FlamegraphAttrs {
  ...
  // When provided, a Flame/Table toggle is shown and 'table' display mode
  // renders this instead of the canvas. The data is the post-filter,
  // post-view-mode tree, so both modes always show the same information.
...
// Chip labels for a state's active filters (e.g. 'Show Stack: main').
