...
import {assertExists, ensureExists} from '../base/assert';
...
export function NodeGraph(): m.Component<NodeGraphAttrs> {
  ...
  function renderConnections(
    ...
    const allDirectPorts = canvasElement.querySelectorAll(
      '.pf-port[data-port]',
    );
    const allWrappedPorts = canvasElement.querySelectorAll(
      '[data-port] > .pf-port',
    );
