...
import { ConversionJobName, ConversionJobStatus } from '../common/conversion_jobs';
import { createEmptyState } from '../common/empty_state';
import { Engine } from '../common/engine';
import { HighPrecisionTime, HighPrecisionTimeSpan } from '../common/high_precision_time';
...
class Globals {
    ...
    initialize(dispatch: Dispatch, router: Router) {
        ...
        this._testing = self.location && self.location.search.indexOf('testing=1') >= 0;
