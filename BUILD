...
perfetto_cc_library(
    ...
    deps = [
               ...
               ":src_trace_processor_importers_proto_v8_importer",
...
# GN target: //src/trace_processor/importers/proto:v8_importer
perfetto_cc_library(
    name = "src_trace_processor_importers_proto_v8_importer",
    srcs = [
        ":src_trace_processor_tables_tables_python",
        "src/trace_processor/importers/proto/jit_tracker.cc",
        "src/trace_processor/importers/proto/string_encoding_utils.cc",
        "src/trace_processor/importers/proto/v8_additional_modules.cc",
    ...
    hdrs = [
        ...
        "src/trace_processor/importers/proto/v8_additional_modules.h",
