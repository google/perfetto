...
perfetto_cc_library(
    ...
    srcs = [
        ...
        ":src_trace_processor_perfetto_sql_lineage_connection_catalog",
        ":src_trace_processor_perfetto_sql_parser_parser",
        ":src_trace_processor_perfetto_sql_pipeline_plan",
        ":src_trace_processor_perfetto_sql_pipeline_syntax",
...
# GN target: //src/trace_processor/perfetto_sql/lineage:connection_catalog
perfetto_filegroup(
    name = "src_trace_processor_perfetto_sql_lineage_connection_catalog",
    srcs = [
        "src/trace_processor/perfetto_sql/lineage/connection_catalog.cc",
        "src/trace_processor/perfetto_sql/lineage/connection_catalog.h",
        "src/trace_processor/perfetto_sql/lineage/type_mapping.h",
    ],
)
...
perfetto_filegroup(
    ...
    srcs = [
        "src/trace_processor/perfetto_sql/pipeline/pipeline_plan.cc",
        "src/trace_processor/perfetto_sql/pipeline/pipeline_plan.h",
    ],
)

# GN target: //src/trace_processor/perfetto_sql/pipeline:syntax
perfetto_filegroup(
    name = "src_trace_processor_perfetto_sql_pipeline_syntax",
    srcs = [
        "src/trace_processor/perfetto_sql/pipeline/pipeline_syntax.cc",
        "src/trace_processor/perfetto_sql/pipeline/pipeline_syntax.h",
    ],
)
