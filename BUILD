...
perfetto_cc_library(
    ...
    srcs = [
        ...
        ":src_trace_processor_importers_art_hprof_art_hprof_event",
...
perfetto_filegroup(
    ...
    srcs = [
        "src/trace_processor/importers/art_hprof/art_hprof_heap_graph.cc",
        ...
        "src/trace_processor/importers/art_hprof/art_hprof_tokenizer.h",
    ],
)

# GN target: //src/trace_processor/importers/art_hprof:art_hprof_event
perfetto_filegroup(
    name = "src_trace_processor_importers_art_hprof_art_hprof_event",
    srcs = [
