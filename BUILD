...
perfetto_filegroup(
    ...
    srcs = [
        ...
        "src/trace_processor/types/per_global_context.h",
        "src/trace_processor/types/per_machine_context.h",
        "src/trace_processor/types/per_trace_context.h",
...
perfetto_filegroup(
    ...
    srcs = [
        ...
        "src/trace_processor/per_global_context.cc",
        "src/trace_processor/per_machine_context.cc",
        "src/trace_processor/per_trace_context.cc",
