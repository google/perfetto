...
perfetto_cc_library(
    ...
    srcs = [
        ...
        ":src_tracing_service_packet_compressor_util",
...
# GN target: //src/tracing/service:packet_compressor_util
perfetto_filegroup(
    name = "src_tracing_service_packet_compressor_util",
    srcs = [
        "src/tracing/service/packet_compressor_util.h",
    ],
)
