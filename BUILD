...
perfetto_cc_library(
    ...
    srcs = [
        ...
        ":src_trace_processor_tables_tables",
        ":src_trace_processor_tables_tables_python",
        ":src_trace_processor_trace_processor_shell_src",
        ":src_trace_processor_trace_summary_trace_summary",
        ":src_trace_processor_types_types",
        ":src_trace_processor_util_args_utils",
        ":src_trace_processor_util_blob",
...
# GN target: //src/trace_processor:trace_processor_shell_src
perfetto_filegroup(
    name = "src_trace_processor_trace_processor_shell_src",
    srcs = [
