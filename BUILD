...
perfetto_cc_library(
    ...
    srcs = [
        ...
        ":src_trace_processor_perfetto_sql_lineage_lineage",
...
# GN target: //src/trace_processor/perfetto_sql/lineage:lineage
perfetto_filegroup(
    name = "src_trace_processor_perfetto_sql_lineage_lineage",
    srcs = [
